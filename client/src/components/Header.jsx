      ...
      <div className="bg-white shadow sticky top-0 z-40">
        <div className="container mx-auto px-4 flex justify-between items-center py-4">
          <Link to="/" className="text-xl font-bold">
            <h1 className='text-pink-400'>CoZA</h1>
          </Link>

          <nav className="hidden md:flex gap-6 text-gray-800 text-sm font-medium">
            <div className="relative group">
              <Link to="/" className="hover:text-blue-500">Home</Link>
              <div className="absolute hidden group-hover:block bg-white shadow-md rounded-md py-2 mt-2 w-40">
                <Link to="/" className="block px-4 py-2 hover:bg-gray-100">Homepage 1</Link>
                <Link to="/home-02" className="block px-4 py-2 hover:bg-gray-100">Homepage 2</Link>
                <Link to="/home-03" className="block px-4 py-2 hover:bg-gray-100">Homepage 3</Link>
              </div>
            </div>
            <Link to="/product" className="hover:text-blue-500">Shop</Link>
            <Link to="/shoping-cart" className="text-red-500 hover:text-red-600">Features</Link>
